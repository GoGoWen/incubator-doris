...
public class CachedClientPool implements ClientPool<IMetaStoreClient, TException> {
    ...
    HiveClientPool clientPool() {
        ...
        String authUser = BDPAuthContext.get().getHadoopUserName() + "_" + BDPAuthContext.get().getErp();
        return clientPoolCache.get(authUser, k -> new HiveClientPool(clientPoolSize, conf));
    }
