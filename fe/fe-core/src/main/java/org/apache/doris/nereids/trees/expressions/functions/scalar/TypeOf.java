...
/**
 * ScalarFunction 'typeof'. Returns textual representation of type of expression passed as a parameter.
 */
public class TypeOf extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(VarcharType.SYSTEM_DEFAULT).args(AnyDataType.INSTANCE_WITHOUT_INDEX)
    );
    ...
    public TypeOf withChildren(List<Expression> children) {
        ...
        return new TypeOf(children.get(0));
    }
