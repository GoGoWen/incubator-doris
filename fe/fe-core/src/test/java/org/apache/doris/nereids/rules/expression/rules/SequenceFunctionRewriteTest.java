...
class SequenceFunctionRewriteTest extends ExpressionRewriteTestHelper {
    ...
    public void testSequenceFunctionRewrite() {
        ...
        Assertions.assertEquals(8, new SequenceFunctionRewrite().buildRules().size());
        ...
        assertRewriteAfterConvertSequenceFunction(new SequenceYearUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
        ...
        assertRewriteAfterConvertSequenceFunction(new SequenceMonthUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
                "array_range_month_unit('2024-05-15 00:00:00', '2024-06-17 00:00:00', 1)",
                ArrayType.of(DateTimeV2Type.SYSTEM_DEFAULT));
        assertRewriteAfterConvertSequenceFunction(new SequenceWeekUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
                "array_range_week_unit('2024-05-15 00:00:00', '2024-05-24 00:00:00', 1)",
                ArrayType.of(DateTimeV2Type.SYSTEM_DEFAULT));
        assertRewriteAfterConvertSequenceFunction(new SequenceDayUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
                "array_range_day_unit('2024-05-15 00:00:00', '2024-05-18 00:00:00', 1)",
                ArrayType.of(DateTimeV2Type.SYSTEM_DEFAULT));
        assertRewriteAfterConvertSequenceFunction(new SequenceHourUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
                "array_range_hour_unit('2024-05-15 00:00:00', '2024-05-17 01:00:00', 1)",
                ArrayType.of(DateTimeV2Type.SYSTEM_DEFAULT));
        assertRewriteAfterConvertSequenceFunction(new SequenceMinuteUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
                "array_range_minute_unit('2024-05-15 00:00:00', '2024-05-17 00:01:00', 1)",
                ArrayType.of(DateTimeV2Type.SYSTEM_DEFAULT));
        assertRewriteAfterConvertSequenceFunction(new SequenceSecondUnit(new DateTimeV2Literal("2024-05-15 00:00:00"),
                        new DateTimeV2Literal("2024-05-17 00:00:00"), new IntegerLiteral(1)),
