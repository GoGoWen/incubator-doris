...
public class TypeCoercionUtilsTest {
    ...
    public void testProcessComparisonPredicateDowngrade() {
        ...
        Assertions.assertEquals(DecimalV2Type.createDecimalV2Type(15, 6), decimalDowngrade.left().getDataType());
        Assertions.assertEquals(DecimalV2Type.createDecimalV2Type(15, 6), decimalDowngrade.right().getDataType());
