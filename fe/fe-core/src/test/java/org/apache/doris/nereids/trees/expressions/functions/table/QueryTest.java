...
public class QueryTest {
    ...
    public void testQueryErrorMesage(@Injectable Auth auth, @Injectable CatalogMgr catalogMgr,
        ...
        new Expectations() {
            {
                auth.checkCtlPriv(UserIdentity.ROOT, "jdbc", PrivPredicate.SELECT);
                minTimes = 1;
                result = true;
            }
        ...
        try {
            ...
            Assertions.assertEquals("Can not build FunctionGenTable 'query'. error: test jdbc error", e.getMessage());
        }
        ...
        try {
            ...
            Assertions.assertEquals("Can not build FunctionGenTable 'query'. error: test error without cause", e.getMessage());
        }
