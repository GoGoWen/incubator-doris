...
public class BDPAuthContextTest {
    ...
    public void testConstructorFromTBDPAuthContext() {
        TBDPAuthContext tBdpAuthContext = new TBDPAuthContext("source", "erp", "hadoop_user", "token", null);
    ...
    public void testConstructorFromTBDPAuthContextWithQueryId() {
        ...
        TUniqueId testQueryId = new TUniqueId(123L, 456L);
        TBDPAuthContext tBdpAuthContext = new TBDPAuthContext("source", "erp", "hadoop_user", "token", testQueryId);
        BDPAuthContext newContext = new BDPAuthContext(tBdpAuthContext);
    ...
    public void testConstructorWithQueryId() {
        ...
        TUniqueId testQueryId = new TUniqueId(456L, 789L);
        BDPAuthContext context = new BDPAuthContext("erp", "source", "user", "token", testQueryId);
    ...
    public void testToStringFormat() {
        ...
        String expected = "bdp_auth_context[erp: test_erp, source: test_source, "
                + "hadoop_user_name: test_hadoop_user, query_id: " + DebugUtil.printId(testQueryId) + "]";
        Assert.assertEquals(expected, result);
    }
    ...
    public void testToStringVariations() {
        ...
        result = context.toString();
        String expected = "bdp_auth_context[erp: test_erp, source: test_source, hadoop_user_name: null, query_id: "
    ...
    public void testTBDPAuthContextConstructorWithNullFields() {
        ...
        TBDPAuthContext tContext = new TBDPAuthContext("source", "erp", "hadoop_user", "token", null);
    ...
    public void testTBDPAuthContextConstructorWithAllFields() {
        ...
        TBDPAuthContext tContext = new TBDPAuthContext("source", "erp", "hadoop_user", "token", queryId);
        ...
        Assert.assertEquals("hadoop_user", context.getHadoopUserName());
        Assert.assertEquals("token", context.getUserToken());
        // Note: userType and businessLine are not copied in the constructor
        Assert.assertNull(context.getUserType());
        Assert.assertNull(context.getBusinessLine());
    ...
    public void testConstructorParameterOrder() {
        ...
        TUniqueId queryId = new TUniqueId(123L, 456L);
        BDPAuthContext contextWithQuery = new BDPAuthContext("test_erp", "test_source", "test_hadoop_user", "test_token", queryId);
    ...
    public void testThriftConversionRoundTrip() {
        ...
        BDPAuthContext originalContext = new BDPAuthContext("original_erp", "original_source",
                "original_hadoop_user", "original_token", originalQueryId);
        ...
        // Note: userType and businessLine are not copied in constructor, erpChanged is not preserved
        Assert.assertNull(reconstructedContext.getUserType());
        Assert.assertNull(reconstructedContext.getBusinessLine());
        Assert.assertFalse(reconstructedContext.isErpChanged());
    }
    ...
    public void testTBDPAuthContextFieldMapping() {
        ...
        TBDPAuthContext tContext = new TBDPAuthContext("t_source", "t_erp", "t_hadoop_user", "t_token", queryId);
