...
public class DateSub extends UDF {
    ...
    /**
     * date_sub_str(String, Integer);
     * select date_sub_str('2023-10-05',1);
     * select date_sub_str('2023-10-05 14:30:45',-1);
     *
     * @param dateStr
     * @param days
     * @return
    ...
    /**
     * date_sub_str(String, Integer, String);
     * select date_sub_str('2023-10-05 14:30:45',1);
     *
     * @param unit
     * @param value
    ...
    /*public String evaluate(String unit, Integer value, String timestamp) {
        if (StringUtils.isEmpty(unit) || value == null || timestamp == null) {
            return null;
        }
        ...
        try {
            ...
            Date newDate = minusTime(date, unit.toUpperCase(), value);
    ...
    /**
     * date_sub_str(String, Integer, Date);
     * select date_sub_str('week',-1,cast('2023-10-05 14:30:45' as date));
     *
     * @param unit
     * @param value
     * @param date
    ...
    private Date minusTime(Date date, String unit, int value) {
    ...
    /**
     * date_sub_str(Datetime,Integer);
     * select date_sub_str(cast('2023-10-05 14:30:45' as datetime),-1);
     *
     * @param dateTime
     * @param days
     * @return
