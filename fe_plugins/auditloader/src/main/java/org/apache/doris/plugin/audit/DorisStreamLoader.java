...
public class DorisStreamLoader {
    ...
    private HttpURLConnection getConnection(String urlStr, String label, String clusterToken) throws IOException {
        ...
        conn.addRequestProperty("columns", "query_id, `time`, client_ip, user, source, hadoop_user_name, erp, catalog, "
                + "db, state, error_code, error_message, query_time, scan_bytes, scan_rows, return_rows, stmt_id, "
                + "is_query, frontend_ip, cpu_time_ms, sql_hash, sql_digest, peak_memory_bytes, stmt");
