...
void ParquetReader::_init_parquet_cols(std::vector<std::string>& parquet_cols, bool* is_hive1_parquet)
{
...
Status ParquetReader::init_reader(
    ...
    _is_hive1_parquet_or_use_idx = (is_hive1_parquet || _is_hive1_parquet_or_use_idx) && colname_to_slot_id;
