...
TEST(DateTimeFunctionTest, year_and_week_test) {
    ...
    {
        InputTypeSet input_types = {TypeIndex::String, TypeIndex::String, TypeIndex::Int32, TypeIndex::Int32};
        DataSet data_set = {
            // With 1 minimal day
            {{std::string("2023-01-01"), std::string("%s-%s"), 2, 1}, std::string("2023-01")},

            // Edge cases
            {{std::string("2024-12-31"), std::string("%s-%s"), 1, 4}, std::string("2025-01")},
            {{std::string("2023-01-01"), std::string("%s-%s"), 6, 3}, std::string("2023-01")},
            
            // Null handling
            {{Null(), std::string("%s-%s"), 2, 4}, Null()},
            {{std::string("2023-01-01"), Null(), 2, 4}, Null()},
            {{std::string("2023-01-01"), std::string("%s-%s"), Null(), 4}, Null()},
            {{std::string("2023-01-01"), std::string("%s-%s"), 2, Null()}, Null()}
        };
        static_cast<void>(check_function<DataTypeString, true>(func_name, input_types, data_set));
    }
}
